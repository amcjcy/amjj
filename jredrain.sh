...
/*
只能用一天。需每天寻找直播抓包
1 8-23 * * * lxk_jd_live_redrain.js
*/
const $ = new Env('超级直播间红包雨');
let allMessage = '', id = 'RRAID';
let bodyList = {
  "18": {
...
echo "$lrr" | sed -e "s/RRAID/$1/g" > /root/jd/scripts/lxk_jd_live_redrain.js

echo "红包雨RRA替换成$1完成"

echo "执行红包雨"

bash /root/jd/jd.sh lxk_jd_live_redrain now